...
const COREL_I18N = {
    pt: {
        ...
        menu_file: 'Arquivo',
        menu_new: 'Novo Documento...',
        menu_open: 'Abrir Arquivo (.CDR, .PDF, .SVG)...',
        menu_open_cdr: 'Importar CorelDRAW (.CDR)',
        menu_open_pdf: 'Importar PDF Vetorial (.PDF)',
        menu_save_svg: 'Salvar / Baixar como SVG',
        menu_export_pdf: 'Exportar Documento PDF',
        menu_export_png: 'Exportar Imagem PNG em Alta',
        menu_prepress: 'Pré-impressão com Sangria & Marcas...',
        menu_print: 'Imprimir Prancheta...',
        menu_download_desktop: 'Instalar Aplicativo no Computador...',
    ...
    en: {
        ...
        menu_open: 'Open File (.CDR, .PDF, .SVG)...',
        menu_open_cdr: 'Import CorelDRAW (.CDR)',
        menu_open_pdf: 'Import Vector PDF (.PDF)',
        menu_save_svg: 'Save / Download as SVG',
        menu_export_pdf: 'Export PDF Document',
        menu_export_png: 'Export High-Resolution PNG',
        menu_prepress: 'Prepress Output with Bleed & Marks...',
        menu_print: 'Print Document...',
        menu_download_desktop: 'Install Desktop App on Computer...',
